...
// array methods:
// food.push('Pasta'); // added to the end of an array
// console.log(food);
// food.splice(1, 1, 'bananas'); // asks for an insertion point, how many things to remove, then the items or item to add
// console.log(food);
...
// food = food.slice(2,5); // the first number is the first element to slice from the array, while the 
...
// flip the values within the array (wht wa sin index 4 is now in 0, 3 to 1, etc.)
